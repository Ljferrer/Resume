...
\begin{tightitemize}
\item \href{https://viterbischool.usc.edu/news/2018/01/usc-isi-develop-translation-information-retrieval-system-uncommon-languages/}{\bf SARAL} -- Working with Transformers for low resource machine translation 
\item Reimplemented several academic papers in PyTorch 
\item Improved our existing NMT system's performance by 1.5 BLEU by incorporating Stochastic Depth to train a 50\% deeper model
...
\runsubsection{Brain-Monitoring Defibrillator}
\descript{| Final Project}
\location{Sept 2016 – Dec 2016 | USC BME 620}
\begin{tightitemize}
...
%\item Modeled the implanted device to render blood flow simulations in SolidWorks
\end{tightitemize}
